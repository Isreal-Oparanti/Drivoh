    ...
    <div className="min-h-screen flex items-center justify-center bg-base-200">
      <div className="card w-full max-w-md shadow-xl p-6 bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <select name="pickUp" className="select select-bordered w-full" onChange={handleChange} required>
            <option value="">Select Pick-Up Point</option>
            <option value="Gate">Gate</option>
            <option value="Moremi">Moremi</option>
            <option value="Fajuyi">Fajuyi</option>
          </select>
          <select name="time" className="select select-bordered w-full" onChange={handleChange} required>
